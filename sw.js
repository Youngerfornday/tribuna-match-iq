...
const CACHE = 'match-iq-v4';
const SHELL = ['./', './index.html', './manifest.webmanifest', './art/captain-ai.webp?v=4', './art/captain-king.webp?v=4', './art/icon-192.png', './art/icon-512.png'];
